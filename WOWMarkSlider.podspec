#
# Be sure to run `pod lib lint WOWMarkSlider.podspec' to ensure this is a
...
This is a customizable UISlider which will show a tooltip when drag the slider.
  ...
  s.source           = { :git => 'https://github.com/zhouhao27/WOWMarkSlider.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'WOWMarkSlider/Classes/**/*'
  
  # s.resource_bundles = {
  #   'WOWMarkSlider' => ['WOWMarkSlider/Assets/*.png']
  # }
